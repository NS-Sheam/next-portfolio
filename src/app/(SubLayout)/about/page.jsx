  ...
  return (
    <section className="bg-bandTernary inner-container py-8 lg:py-14">
      ...
      <div className="py-5 md:py-8 space-y-4 flex flex-col md:flex-row bg-bandSecondary items-start justify-between">
                  ...
                  <div key={index}>
                    ...
                    <ul className=" pl-4">
                      {mySkills[skill].map((item, index) => {
                        return (
                          <li
                            className="banner-name-font font-bold"
                            key={index}
                          >
        ...
        >
          <p className="text-center text-4xl col-span-2 font-extrabold uppercase text-green-500">
          ...
          <div className="col-span-2 space-y-2">
            ...
            <hr />
            <p>
              HTML5 | CSS3 | JavaScript ES6 | React.js | Tailwind | Bootstrap |
              React Bootstrap | DaisiUI | Flowbite | Express and Node.js |
              Typescript | Rest API | Mongoose | Devtool and Debugging | MongoDB
              | JWT | React Hook Form | Prisma | Redux | Next.js | PostgreSQL |
              Git | Adobe Photoshop | Adobe Illustrator | GitHub | Visual Studio
              Code | Firebase | React Router | Netlify | Surge | Vercel | Dotenv
              | Figma | Chrome Dev Tools | Canva
            </p>
          </div>
          ...
          <p>
            LinkedIn:{" "}
            <Link
              href="https://linkedin.com/in/nazmus-sakib-sheam"
          ...
          <p>
            Github:{" "}
            <Link
              href="https://github.com/nS-Sheam/"
              className="font-bold text-green-500"
            >
              NS-Sheam
            </Link>
          ...
          <button
            ...
            className={`gradient-btn border-2 border-white mx-auto w-56 block py-2 px-5 rounded-full text-white font-bold`}
          >
            Download Resume
          </button>
          <button
