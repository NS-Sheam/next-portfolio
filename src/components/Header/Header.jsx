            ...
            <section className='lg:hidden my-container px-4 py-4 flex justify-between items-center'>
                ...
                <div className='flex flex-col justify-center items-center z-20'>
                    ...
                    <div className=' w-4/5 mx-auto absolute top-14 right-0 left-0'>
                        <ul className={` header-list text-bandFont mb-2 text-xl flex flex-col items-center gap-2 sm-menu-item transform duration-500 rounded-md border p-2 m-2 border-white z-20 bg-black bg-opacity-60 backdrop-blur-sm  ${isMenuOpen ? "visible" : "hidden"}`}>
                            {
