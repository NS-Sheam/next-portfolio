...
import { FaFacebook, FaFile, FaGithub, FaInstagram, FaLinkedin, FaSnapchat, FaUser, FaYoutube } from 'react-icons/fa';
import "./Footer.css";
            ...
            <footer className="inner-container pt-10 pb-14 md:pb:6 md:pt-20 md:pb-2 bg-gradient-to-r from-bandPrimary via-bandSecondary to-bandTernary text-white mx-auto ">
                <div className='gap-14 md:grid grid-cols-5 space-y-6'>
                    <div className='col-span-3 space-y-3'>
                        ...
                        <h2 className='text-5xl font-extrabold banner-name-font text-center lg:text-left '>Get In Touch</h2>
                        <p className='text-white md:w-4/5 text-justify lg:text-left '>Connect with me! Whether you have a project in mind, want to collaborate, or just say hello, I'd love to hear from you. Feel free to reach out through the form below or connect with me on social media. Let's turn ideas into reality and create something amazing together!</p>
                        ...
                        <div className="social-buttons flex flex-wrap justify-center md:justify-start gap-2">
                            ...
                            <Link href="https://www.instagram.com/nazmus_sakib_sheam/" className="social-button social-button--instagram" aria-label="Instagram">
                                <FaInstagram />
                            </Link>
