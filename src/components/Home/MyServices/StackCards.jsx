                ...
                <ul id="cards">
                    <li className="card" id="card_1">
                        <div className="card__content">
                            ...
                            <figure>
                                {/* <Image src="https://codyhouse.co/demo-tutorials/stacking-cards/assets/img/img-1.jpg" alt="Image description" /> */}
                                <h2>Hello</h2>
                            </figure>
                        </div>
                    </li>
                    <li className="card" id="card_2">
                        <div className="card__content">
                            ...
                            <figure>
                                {/* <Image src="https://codyhouse.co/demo-tutorials/stacking-cards/assets/img/img-2.jpg" alt="Image description" /> */}
                                <h2>Hello</h2>
                            </figure>
                        </div>
                    </li>
                    <li className="card" id="card_3">
                        <div className="card__content">
                            ...
                            <figure>
                                {/* <Image src="https://codyhouse.co/demo-tutorials/stacking-cards/assets/img/img-3.jpg" alt="Image description" /> */}
                                <h2>Hello</h2>
                            </figure>
                        </div>
                    </li>
