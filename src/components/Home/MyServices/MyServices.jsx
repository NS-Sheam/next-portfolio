...
const MyServices = () => {
  return (
    <section className=" space-y-4 py-6">
      <h1 className="text-3xl md:text-6xl font-bold text-band-orange text-center">Trailblazing Software Teams</h1>
      <h2 className="text-2xl md:text-4xl font-bold text-white text-center">
        Comprehensive Software Development Services <br /> <span className="text-3xl font-semibold">Streamlining Processes & Enhancing User Experiences</span>
      </h2>
