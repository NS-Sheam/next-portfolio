...
const Skills = () => {
  ...
  return (
    <section className="relative bg-gradient-to-tr from-bandPrimary to-bandSecondary inner-container lg:min-h-screen py-4 lg:py-6 z-20">
      ...
      >
        <h1 className="text-white text-3xl lg:text-5xl italic font-bold mb-4">
          Skills
        </h1>
        <Marquee autoFill={true} className="rounded-3xl">
          {skills?.map((skill, i) => (
            <div
              className="w-12 h-12 lg:w-20 lg:h-20 flex justify-center items-center mx-4 "
              key={i}
            >
              <Image
                className={`${
                  skill == skillImg8 ? "rounded-2xl bg-white" : ""
                }`}
                src={skill}
                alt=""
              />
        ...
        <p className="text-white text-justify lg:text-center lg:text-xl mb-4 w-3/4 mx-auto">
          ...
          development to back-end programming, UI/UX design, database
          management, and more, my skills cover a wide range of areas in web
          development. Explore the skills section to see how my technical
          proficiencies align with your project requirements and discover the
          value I can bring to your team.{" "}
        </p>
